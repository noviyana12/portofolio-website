            ...
            <Container>
                <Row className="align-items-center">
                    <Col md={3} sm={12} xs={12} className="profile-banner-section">
                        ...
                        <Button variant="warning" className="download-cv-btn">Download CV</Button>
                    </Col>
                    ...
                    <Col md={3} sm={12} xs={12} className="intro-banner-section">
                        ...
                        <a href="#" className="intro-learn-more"><span>Learn more <i className="ri-arrow-down-line"></i></span></a>
                    </Col>
                </Row>
            </Container>
        </section>
